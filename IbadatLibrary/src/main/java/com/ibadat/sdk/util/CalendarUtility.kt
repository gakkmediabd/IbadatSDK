...
internal class CalendarUtility {
    fun getCurrentHour(): Int {
        return Calendar.getInstance().get(11)
    }

    fun getCurrentMinutes(): Int {
        return Calendar.getInstance()[12]
    }
    ...
    private fun get01Valu(str: String?): String? {
    ...
    fun getWeekName(calendar: Calendar, context: Context): String {
        ...
        val stringArray: Array<String> =
            context.resources.getStringArray(R.array.week_name_bangla)
        if (1 == i) {
